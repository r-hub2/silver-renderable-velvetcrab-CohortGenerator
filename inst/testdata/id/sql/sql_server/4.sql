...
select @target_cohort_id as cohort_definition_id, person_id, CASE WHEN start_date > DATEFROMPARTS(2000, 1, 1) THEN start_date ELSE DATEFROMPARTS(2000, 1, 1) END, end_date 
FROM #final_cohort CO
WHERE CASE WHEN start_date > DATEFROMPARTS(2000, 1, 1) THEN start_date ELSE DATEFROMPARTS(2000, 1, 1) END <= end_date
;
